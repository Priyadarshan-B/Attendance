...
const Excel = require('../Controllers/Reports/insertBioRecords')
...
const without_slot = require('../Controllers/Reports/without_exem_slot')
const with_slot = require('../Controllers/Reports/with_exem_slot')
...
router.post('/biometrics', bio_attendence.getBiometric)
...
router.get('/without-slot',without_slot.getAttendanceByDate)
router.get('/with-slot', with_slot.getAttendanceByDate)
// logs
